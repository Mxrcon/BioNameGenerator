function Get-BacterialSpecie{
    $BacterialSpecies = @(   
        ...
        "carbinolica",
        "caulinodans")
    return $BacterialSpecies[$(Get-Random -Maximum $BacterialSpecies.count)]
}
